...
ActiveRecord::Schema.define(version: 20160505153148) do
  ...
  add_index "labwares", ["barcode"], name: "index_labwares_on_barcode", using: :btree
  add_index "labwares", ["external_id"], name: "index_labwares_on_external_id", using: :btree
  add_index "labwares", ["labware_type_id"], name: "index_labwares_on_labware_type_id", using: :btree
  add_index "labwares", ["uuid"], name: "index_labwares_on_uuid", using: :btree
  ...
  add_index "metadata", ["key", "labware_id"], name: "index_metadata_on_key_and_labware_id", unique: true, using: :btree
  add_index "metadata", ["labware_id"], name: "index_metadata_on_labware_id", using: :btree
  ...
  add_index "receptacles", ["labware_id"], name: "index_receptacles_on_labware_id", using: :btree
  add_index "receptacles", ["location_id"], name: "index_receptacles_on_location_id", using: :btree
